...
import type { ExternalBlob as _ExternalBlob, UserId as _UserId, UserProfile as _UserProfile, UserRole as _UserRole, VideoId as _VideoId, VideoResponse as _VideoResponse, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllVideos(): Promise<Array<VideoResponse>> {
        if (this.processError) {
            try {
    ...
    async getPointsBalance(arg0: UserId): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getPointsBalance(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getProfileVideos(arg0: UserId): Promise<Array<VideoResponse>> {
        if (this.processError) {
            try {
                const result = await this.actor.getProfileVideos(arg0);
                return from_candid_vec_n10(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getVideo(arg0: VideoId): Promise<VideoResponse> {
        if (this.processError) {
            try {
                const result = await this.actor.getVideo(arg0);
                return from_candid_VideoResponse_n11(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getWatchHistory(arg0: UserId): Promise<Array<WatchRecordResponse>> {
        if (this.processError) {
            try {
    ...
    async uploadVideo(arg0: VideoId, arg1: string, arg2: string, arg3: string, arg4: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadVideo(arg0, arg1, arg2, arg3, await to_candid_ExternalBlob_n17(this._uploadFile, this._downloadFile, arg4));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async watchVideo(arg0: VideoId): Promise<void> {
        if (this.processError) {
            try {
...
async function from_candid_VideoResponse_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _VideoResponse): Promise<VideoResponse> {
...
async function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_VideoResponse>): Promise<Array<VideoResponse>> {
    return await Promise.all(value.map(async (x)=>await from_candid_VideoResponse_n11(_uploadFile, _downloadFile, x)));
}
